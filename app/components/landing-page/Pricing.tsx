    ...
    <div className="my-[150px] flex flex-col items-center gap-14">
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-content-body text-center text-xl">
          Junte-se á uma comunidade de criadores profissionais que ja estão
          elevando sua <br />
          experiencia online. Teste gratuitamente por{" "}
      ...
      <div className="flex items-end gap-9">
        <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border border-[#1e1e1e]">
          <div className="flex flex-col">
            ...
            <span className="text-contnt-body"></span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-white font-bold text-xl">R$9,90</span>
